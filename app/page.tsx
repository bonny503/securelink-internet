export default function Home() {
  ...
  // List of all 9 photos you uploaded
  const projectPhotos = [
    { url: '/work/photo-1.jpg', title: 'Network Infrastructure' },
    { url: '/work/photo-2.jpg', title: 'Hikvision Stock' },
    { url: '/work/photo-3.jpg', title: 'ColorVu Systems' },
    { url: '/work/photo-4.jpg', title: 'UNV Camera Kits' },
    { url: '/work/photo-5.jpg', title: 'CCTV Monitoring' },
    { url: '/work/photo-6.jpg', title: 'System Configuration' },
    { url: '/work/photo-7.jpg', title: 'Turbo HD DVRs' },
    { url: '/work/photo-8.jpg', title: 'Server Rack Setup' },
    { url: '/work/photo-9.jpg', title: 'Professional Cabling' }
  ];
  ...
  return (
    <main style={{ backgroundColor: '#0a192f', color: '#ffffff', minHeight: '100vh', fontFamily: 'sans-serif', padding: '40px 20px' }}>
      ...
      {/* Gallery Section - Now with 9 Photos */}
      <section style={{ maxWidth: '1100px', margin: '0 auto 60px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(280px, 1fr))', gap: '20px' }}>
          {projectPhotos.map((photo, index) => (
            <div key={index} style={{ borderRadius: '12px', overflow: 'hidden', border: '1px solid #1e293b', backgroundColor: '#112240', transition: 'transform 0.2s' }}>
              <img 
                src={photo.url} 
                alt={photo.title} 
                style={{ width: '100%', height: '250px', objectFit: 'cover', display: 'block' }} 
                onError={(e) => { e.currentTarget.src = 'https://via.placeholder.com/400x300?text=Photo+Coming+Soon'; }}
              />
      ...
      <section style={{ maxWidth: '1000px', margin: '80px auto' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '30px' }}>
          <div style={{ padding: '30px', borderRadius: '12px', backgroundColor: '#112240', border: '2px solid #10b981', textAlign: 'center' }}>
            ...
            <p style={{ fontSize: '1.5rem', fontWeight: 'bold' }}>Starting at KES XX,XXX</p>
            <ul style={{ listStyle: 'none', padding: 0, color: '#94a3b8', lineHeight: '2.5' }}>
              <li>✓ Full HD Night Vision Cameras</li>
              <li>✓ Mobile App Configuration</li>
              <li>✓ Motion Alerts & Notifications</li>
            </ul>
          </div>
      ...
      <footer style={{ textAlign: 'center', marginTop: '100px', color: '#64748b', borderTop: '1px solid #1e293b', paddingTop: '30px' }}>
        <p>© 2026 SecureLink Internet & CCTV Services. Professional Solutions for a Secure Future.</p>
      </footer>
    </main>
  );
}
